        ...
        <div className="grid grid-cols-1 gap-8 lg:grid-cols-3">
          <div>
            ...
            <p className="max-w-md mx-auto mt-6 leading-relaxed text-center text-gray-500 sm:max-w-xs sm:mx-0 sm:text-left">
              Contactame en mis redes sociales, para conocer mas sobre el desarrollo web, cloud, devops y más...
            </p>
          ...
          <div className="grid grid-cols-1 gap-8 sm:grid-cols-2 lg:col-span-2 md:grid-cols-4">
            ...
            <div className="text-center sm:text-left">
              ...
              <ul className="mt-8 text-sm space-y-4">
                <li>
                  <Link href="/">
                    <a className="flex items-center justify-center gap-1.5 sm:justify-start">
                      <svg
                        xmlns="http://www.w3.org/2000/svg"
                      ...
                      <span className="text-gray-700">pbl.gllgs@gmail.com</span>
                    </a>
                  </Link>
                </li>
                ...
                <li>
                  <Link href="/">
                    <a className="flex items-center justify-center gap-1.5 sm:justify-start">
                      ...
                      <span className="text-gray-700">+56957592973</span>
                    </a>
                  </Link>
                </li>
